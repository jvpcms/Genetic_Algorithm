...
def simulate(networks, population_size, number_survivors, current_gen, current_batch):
    ...
    while True:
        ...
        pygame.display.set_caption(f'Generation {current_gen}, Bach: {current_batch} - Ailive Entities: {n_live}')
